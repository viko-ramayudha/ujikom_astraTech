...
<div class="container" style="margin-top: 35px;">
        ...
        <p><span class="error-message text-danger fw-600">@error('name') {{ $message }} @enderror</span></p>
            <table border="0">
                <tr>
                    <td><label for="nim">Kode</label></td>
                </tr>
                <tr>
                    <td><input class="inp" type="text" id="kode" name="kode" placeholder="Kode" minlength="8" maxlength="8" required></td>
                ...
                <tr>
                    <td><input class="inp" type="text" id="name" name="name" placeholder="Nama Produk" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="price" placeholder="Price" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="stock" placeholder="Stock" required></td>
                </tr>
