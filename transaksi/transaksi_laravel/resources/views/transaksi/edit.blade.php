...
<div class="container" style="margin-top: 35px;">
        ...
        <form action="{{ route('transaksi.update', $transaksis->id_trx) }}" method="POST" >  @csrf
            @method('PUT')
            ...
            <table border="0">
                ...
                <tr>
                    <td><input class="inp" type="text" id="kode" name="kode" value="{{ $transaksis->tgl_trx }}" readonly></td>
                </tr>
                <tr>
                    <td><label>Nama Transaksi</label></td>
                </tr>
                <tr>
                    <td><input class="inp" type="text" id="id_layanan" name="id_layanan" value="{{ $transaksis->id_layanan }}" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="id_user" value="{{ $transaksis->id_user }}" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="id_userr" value="{{ $transaksis->id_userr }}" required></td>
                </tr>
                <tr>
                    <td><label>Stock</label></td>
                </tr>
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="tgl_janjian" value="{{ $transaksis->tgl_janjian }}" required></td>
                </tr>
                <tr>
                    <td><label>Stock</label></td>
                </tr>
                <tr>
                    <!-- <td>Prodi</td> -->
                    <td><input class="inp" type="text" name="total_hrg" value="{{ $transaksis->total_hrg }}" required></td>
                </tr>
